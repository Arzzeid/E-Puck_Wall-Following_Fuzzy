...
delta_error = ctrl.Antecedent(np.arange(-30, 90, 0.01), 'delta_error')
...
def flc_computea(nilai_errora, nilai_delta_errora):
    control_sim.input['error'] = nilai_errora
    control_sim.input['delta_error'] = nilai_delta_errora
    control_sim.compute()
